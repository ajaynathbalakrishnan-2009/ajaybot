...
import { X, Key, Sliders, User, Trash2, Check, Sparkles, AlertCircle, Eye, EyeOff, Cpu, Globe, Zap } from 'lucide-react';
        ...
        <div className="p-6 space-y-5 max-h-[75vh] overflow-y-auto">
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-2">
              <button
                type="button"
                onClick={() => handleChange('provider', 'simulated')}
              ...
              >
                ...
                <p className="text-[11px] text-slate-400 leading-snug">
                  Zero setup, offline capable, multi-task reasoning & artifacts.
                </p>
              </button>
              ...
              >
                ...
                <p className="text-[11px] text-slate-400 leading-snug">
                  Connect Google AI Studio free tier key.
                </p>
              </button>
              ...
              >
                ...
                <p className="text-[11px] text-slate-400 leading-snug">
                  Access open models & GPT-4o with API key.
                </p>
              </button>
              ...
              >
                ...
                <p className="text-[11px] text-slate-400 leading-snug">
                  Connect direct Anthropic API key.
                </p>
              </button>
            </div>
          </div>
          ...
          {formData.provider !== 'simulated' && (
            <div className="p-4 rounded-2xl bg-indigo-500/10 border border-indigo-500/20">
              <label className="block text-xs font-semibold text-slate-800 dark:text-slate-200 mb-1.5">
                {formData.provider === 'gemini' ? 'Gemini API Key' : formData.provider === 'openrouter' ? 'OpenRouter / OpenAI Key' : 'Anthropic API Key'}
              </label>
              <div className="relative">
                <input
                  ...
                  className="w-full pl-3.5 pr-10 py-2 rounded-xl text-xs font-mono border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-900 text-slate-800 dark:text-slate-200 focus:outline-none focus:ring-2 focus:ring-brand-primary/50"
                />
                <button
                  type="button"
              ...
              <p className="text-[11px] text-slate-400 mt-1.5 flex items-center space-x-1">
                ...
                <span>Keys are stored only in your local browser sandbox.</span>
              </p>
            </div>
          )}
          ...
          <div className="flex items-center justify-between p-3.5 rounded-2xl border border-slate-200 dark:border-brand-border bg-slate-50/50 dark:bg-slate-900/40">
            <div>
              ...
              <span className="text-[11px] text-slate-400">
                Display step-by-step chain-of-thought tokens before answers.
              </span>
            </div>
